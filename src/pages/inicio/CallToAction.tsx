...
const CallToAction = () => {
  return (
    <div className="py-12 2xl:py-24 2xl:px-12 rounded-xl bg-seccion mb-6 flex flex-row relative overflow-hidden justify-center 2xl:justify-start">
      <div className="flex flex-col items-center 2xl:items-start w-full px-3">
        <h1 className="title-seccion mb-3 text-center 2xl:text-left">Descubre una nueva forma de leer</h1>
        <p className="text-white text-center 2xl:test-left">Estás a un solo clic de transformar tu hábito de lectura.</p>
        <p className="text-white w-full md:w-96 2xl:w-96 mb-4 text-center 2xl:text-left">Prueba nuestra Lectura Acompañada y disfruta de la experiencia de leer con compañía.</p>
